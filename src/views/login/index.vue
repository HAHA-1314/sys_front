  ...
  <div class="login-container">
    ...
    >
      <div class="title-container">
        <h1 class="big_title">加密流量分析系统-登录</h1>
      </div>
      ...
      <el-button
        ...
        >登 录</el-button
      >
      <span class="tips">还没有账号？</span>
      <router-link :to="toReg" class="tips">前往注册</router-link>
    </el-form>
  </div>
</template>
  ...
  watch: {
    $route: {
      handler: function (route) {
        ...
        this.toReg = route.query.redirect ? `/register?redirect=${route.query.redirect}` : "/register";
      },
      immediate: true,
    },
  },
